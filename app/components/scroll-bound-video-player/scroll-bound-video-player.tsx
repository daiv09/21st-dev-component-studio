                ...
                >
                    <div className="relative z-10 w-full px-6">
                        <div className="mx-auto max-w-3xl md:max-w-4xl">
                            <div className="flex flex-col items-center text-center p-8 md:p-12 rounded-3xl bg-white/5 backdrop-blur-sm border border-white/10 shadow-2xl">
                                {badge && (
                                    <FadeIn>
                                ...
                                <FadeIn delay={0.2}>
                                    <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-6 leading-[0.9] text-white mix-blend-overlay">
                                        {title}
                                    </h1>
                                </FadeIn>
                                ...
                                {subtitle && (
                                    <FadeIn delay={0.4}>
                                        <p className="text-lg md:text-xl text-white font-light mb-10 max-w-2xl mx-auto leading-relaxed">
                                            {subtitle}
                                        </p>
                                    </FadeIn>
                                )}
